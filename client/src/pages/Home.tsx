...
const entries = [
  {
    ...
    title: '大屏端',
    subtitle: '指挥中心',
    description: '全园区态势一目了然，机器人实时位置、事件告警、待处置事件列表、快速启动预案，适用于指挥中心大屏',
    color: 'sky',
    ...
    features: ['机器人实时位置', '事件待处置', '快速预案', '趋势图表'],
  },
  {
    path: '/admin',
    icon: Briefcase,
    title: '业务端',
    subtitle: '管理后台',
    description: '管理人员专用，远程查看机器人实时画面、一键启动任务预案、处置事件、管理访客和排班',
    color: 'violet',
  ...
  },
  {
    ...
    title: '移动端',
    subtitle: '保安 App',
    description: '一线保安专用，大按鈕快速操作，接收事件、处置告警、呼叫机器人支援，无需技术背景即可上手',
    color: 'emerald',
